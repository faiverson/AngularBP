module.exports = function ( grunt ) {
  ...
  var taskConfig = {
    ...
    html2js: {
      ...
      app: {
        ...
        src: [ '<%= app_files.atpl %>' ],
        dest: '<%= public_dir %>/templates-app.js'
      },
      ...
      common: {
        ...
        src: [ '<%= app_files.ctpl %>' ],
        dest: '<%= public_dir %>/templates-common.js'
      }
    },
    ...
    karma: {
      options: {
        configFile: '<%= public_dir %>/karma-unit.js'
      },
      unit: {
        port: 9019,
        background: true
    ...
    delta: {
      ...
      jssrc: {
        ...
        //tasks: [ 'jshint:src', 'karma:unit:run', 'copy:public_appjs' ]
  ...
  grunt.registerMultiTask( 'karmaconfig', 'Process karma config templates', function () {
    ...
    grunt.file.copy( 'karma/karma-unit.tpl.js', grunt.config( 'public_dir' ) + '/karma-unit.js', {
      process: function ( contents, path ) {
        return grunt.template.process( contents, {
          data: {
            scripts: jsFiles
